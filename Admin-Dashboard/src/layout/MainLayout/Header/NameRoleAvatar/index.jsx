...
//           <Avatar {...stringAvatar(name)} sx={{ width: 60, height: 60, bgcolor: '#14c0c3ff', color: '#fff' }} />
...
//   const phone = userData?.phone || userData?.phoneNumber || userData?.mobile || 'N/A';
//   const role = userData?.role || userData?.userRole || userData?.userType || 'Vendor';
//   const status = userData?.status || 'N/A';
//   const district = userData?.district || userData?.location || '';
...
//           <Divider sx={{ width: '100%', my: 1, bgcolor: '#E5E7EB' }} />
...
//               <span
//                 style={{
//                   color: status === 'active' ? '#22c55e' : status === 'N/A' ? '#9ca3af' : '#ef4444',
//                   fontWeight: 600,
//                   textTransform: 'capitalize'
//                 }}
//               >
...
export default function BackgroundLetterAvatars() {
  ...
  // Extract user info
  const name = admin?.name || 'User';
const email = admin?.email || 'N/A';
const role = admin?.role || 'N/A';
const status = admin?.status || 'N/A';
        ...
        <Stack direction="column" alignItems="center" spacing={1.2}>
          ...
          <Box sx={{ width: '100%' }}>
            ...
            <Typography variant="body2" sx={{ color: '#364152' }}>
              ...
              <span
                style={{
                  color: status === 'active' ? '#22c55e' : status === 'N/A' ? '#9ca9afff' : '#ef4444',
                  fontWeight: 600,
                  textTransform: 'capitalize'
                }}
              >
