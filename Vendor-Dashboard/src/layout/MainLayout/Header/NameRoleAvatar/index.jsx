...
//           <Avatar {...stringAvatar(name)} sx={{ width: 60, height: 60, bgcolor: '#31aebaff', color: '#fff' }} />
...
export default function BackgroundLetterAvatars() {
  ...
  const role = userData?.role || userData?.userRole || userData?.userType || 'N/A';
  const status = userData?.status || 'N/A';
  const district = userData?.district || userData?.location || 'N/A';
