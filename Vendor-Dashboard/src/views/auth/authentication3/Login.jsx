...
const AuthLogin = (props) => {
  ...
  const [loginError, setLoginError] = useState('');
  const [showPassword, setShowPassword] = useState(false);
  const [selectedRole, setSelectedRole] = useState('vendor'); // 👈 new
    ...
    >
      ...
      >
        ...
        >
          <Button
            ...
            sx={{
              ...
              fontWeight: 600,
              borderRadius: 0,
              backgroundColor: selectedRole === 'vendor' ? '#07806dff' : 'white',
              color: selectedRole === 'vendor' ? 'white' : '#07806dff',
              '&:hover': {
                backgroundColor: selectedRole === 'vendor' ? '#07806dff' : '#f0faf8'
              }
            }}
          >
            Vendor
          ...
          <Button
            ...
            sx={{
              ...
              fontWeight: 600,
              borderRadius: 0,
              backgroundColor: selectedRole === 'staff' ? '#07806dff' : 'white',
              color: selectedRole === 'staff' ? 'white' : '#07806dff',
              '&:hover': {
                backgroundColor: selectedRole === 'staff' ? '#07806dff' : '#f0faf8'
              }
            }}
          >
            Staff
        ...
        <Formik
          initialValues={{ client_id: 'webapp', client_secret: 'saqw21!@', email: '', password: '' }}
          validationSchema={validate}
          onSubmit={(values) => dispatch(userLogin({ ...values, navigate, role: selectedRole }))} // 👈 role added
        >
          {() => (
            <Form style={{ width: '100%' }}>
              <Stack spacing={2}>
                ...
                >
                  {selectedRole === 'staff' ? 'Login as Staff' : 'Login as Vendor'} {/* 👈 dynamic label */}
                </Button>
              </Stack>
            </Form>
          )}
